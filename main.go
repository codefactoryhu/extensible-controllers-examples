...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "ffb63a50.codefactory.hu",
	})
	if err != nil {
	...
	if err = (&finalizingcontrollers.MachineReconciler{
	...
	if err = (&finalizingcontrollers.VolumesBackupReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
	...
	if err = (&paternalcontrollers.BasicReplicaSetReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "BasicReplicaSet")
		os.Exit(1)
	}
